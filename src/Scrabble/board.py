...
class Board:
    ...
    def would_be_connected(self, word, location, direction):
        """
        Returns True if word, placed at location in direction, would be connected. In other words.txt, word must contain
    ...
    def would_create_only_legal_words(self, word, location, direction):
        """
        Returns true if word, played at location in direction, would create only legal words.txt.
        """
    ...
    def score(self, word, location, direction):
        """
        Returns the score for playing word at location in direction, including any cross words.txt.
        """
